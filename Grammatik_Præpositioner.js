...
const praepositionGrammarPages = [
            ...
            <table class="grammar-preposition-table">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>efter</td>
                        <td>arbejdet</td>
                        <td>efter arbejdet</td>
                    </tr>
                    <tr>
                        <td>for</td>
                        <td>at lære dansk</td>
                        <td>for at lære dansk</td>
                    </tr>
                    <tr>
                        <td>på</td>
                        <td>om han kommer</td>
                        <td>på, om han kommer</td>
                    </tr>
                </tbody>
            </table>
            ...
            <table class="grammar-comparison-table">
                ...
                <tbody>
                    <tr class="grammar-comparison-forms">
                        <td>jeg</td>
                        <td>mig</td>
                        <td>Kom <u>med</u> mig.</td>
                    </tr>
                    <tr class="grammar-comparison-forms">
                        <td>du</td>
                        <td>dig</td>
                        <td>Jeg taler <u>med</u> dig.</td>
                    </tr>
                    <tr class="grammar-comparison-forms">
                        <td>han / hun</td>
                        <td>ham / hende</td>
                        <td>Brevet er <u>til</u> hende.</td>
                    </tr>
                    <tr class="grammar-comparison-forms">
                        <td>vi / I / de</td>
                        <td>os / jer / dem</td>
                        <td>Hun arbejder <u>sammen med</u> dem.</td>
                    </tr>
                </tbody>
            </table>
            <aside class="grammar-tip">
    ...
    },
    {
        ...
        content: `
            ...
            <table class="grammar-preposition-table">
                ...
                <tbody>
                    <tr>
                        <td>Styrelsen er underforstået</td>
                        <td>Vil du <u>med</u>?</td>
                        <td>med mig/os</td>
                    </tr>
                    <tr>
                        <td>Spørgsmål</td>
                        <td>Hvem taler du <u>med</u>?</td>
                        <td>med hvem</td>
                    </tr>
                    <tr>
                        <td>Leddet står først</td>
                        <td>Den by har jeg boet <u>i</u>.</td>
                        <td>i den by</td>
                    </tr>
                    <tr>
                        <td>Relativ sætning</td>
                        <td>Det er bogen, jeg talte <u>om</u>.</td>
                        <td>om bogen</td>
                    </tr>
                    <tr>
                        <td>Fast forbindelse</td>
                        <td>Hør <u>efter</u>!</td>
                        <td>efter det, der siges</td>
                    </tr>
                </tbody>
            </table>
            <aside class="grammar-tip">
                <p lang="da">
                    Formelt kan man skrive <strong>Med hvem taler du?</strong> I almindeligt dansk er
    ...
    },
    {
        ...
        content: `
            <table class="grammar-preposition-table grammar-decision-table">
                <thead>
                    <tr>
                        <th>
                            <span class="grammar-paired-label">
    ...
    },
    {
        ...
        content: `
            <table class="grammar-correction-table grammar-correction-table--paired">
                ...
                <tbody>
                    <tr>
                        <td class="grammar-result grammar-result--incorrect">Jeg bor på Danmark.</td>
                    ...
                    <tr>
                        ...
                        <td class="grammar-result grammar-result--correct">Jeg er hjemme.</td>
                    </tr>
                    <tr class="grammar-correction-reason">
                        <td colspan="2">
                            Hjem viser retning; hjemme viser sted.<br /><em lang="en"
                                >Hjem expresses direction; hjemme expresses location.</em
                            >
                        </td>
                    </tr>
                    <tr>
                        <td class="grammar-result grammar-result--incorrect">Vi ses i mandag.</td>
                    ...
                    <tr>
                        ...
                        <td class="grammar-result grammar-result--correct">Jeg kommer om en time.</td>
                    </tr>
                    <tr class="grammar-correction-reason">
                        <td colspan="2">
                    ...
                    <tr>
                        <td class="grammar-result grammar-result--incorrect">Jeg har boet her siden fem år.</td>
                        <td class="grammar-result grammar-result--correct">Jeg har boet her i fem år.</td>
                    </tr>
                    <tr class="grammar-correction-reason">
                        <td colspan="2">
                    ...
                    <tr>
                        <td class="grammar-result grammar-result--incorrect">Jeg venter til bussen.</td>
                        <td class="grammar-result grammar-result--correct">Jeg venter på bussen.</td>
                    </tr>
                    <tr class="grammar-correction-reason">
                        <td colspan="2">Fast forbindelse: vente på.<br /><em lang="en">The fixed combination is vente på.</em></td>
                    </tr>
                    <tr>
                        <td class="grammar-result grammar-result--incorrect">Mellem dig og jeg.</td>
                        <td class="grammar-result grammar-result--correct">Mellem dig og mig.</td>
                    </tr>
                    <tr class="grammar-correction-reason">
                        <td colspan="2">
...

    {
        ...
        content: `
            <section class="grammar-exercise">
                <h3>A. Find præposition og styrelse</h3>
                <ol>
                    <li>Bogen ligger på det store bord.</li>
                    <li>Hun rejser med sin søster.</li>
                    <li>Vi mødes efter arbejdet.</li>
                    <li>Han er bange for at flyve.</li>
                    <li>Jeg tænker på, om hun kommer.</li>
                </ol>
            </section>
            <section class="grammar-exercise">
                <h3>B. I, på, hos eller ved?</h3>
                <ol>
                    <li>Hun bor ___ Aarhus.</li>
                    <li>Bogen ligger ___ bordet.</li>
                    <li>Jeg har en tid ___ lægen.</li>
                    <li>Vi mødes ___ stationen.</li>
                    <li>De er ___ arbejde.</li>
                    <li>Han sidder ___ bilen.</li>
                    <li>Hun bor ___ Fyn.</li>
                    <li>Vi spiser ___ mine forældre.</li>
                </ol>
            </section>
            <section class="grammar-exercise">
                <h3>C. Retning</h3>
                <ol>
                    <li>Vi kører ___ København.</li>
                    <li>Hun kommer ___ Sverige.</li>
                    <li>Bussen kører ___ skolen.</li>
                    <li>De gik ___ parken.</li>
                    <li>Toget kører ___ nord.</li>
                </ol>
            </section>
            <section class="grammar-exercise">
                <h3>D. Tidsudtryk</h3>
                <ol>
                    <li>Vi ses ___ fredag.</li>
                    <li>Toget kommer ___ ti minutter.</li>
                    <li>Jeg har boet her ___ tre år.</li>
                    <li>Hun flyttede hertil ___ to år siden.</li>
                    <li>Jeg har arbejdet her ___ januar.</li>
                    <li>Vi arbejder ___ klokken 8 ___ 16.</li>
                    <li>Han læste bogen ___ to dage.</li>
                </ol>
            </section>
            <section class="grammar-exercise">
                <h3>E. Fast præposition</h3>
                <ol>
                    <li>Jeg venter (på / til) bussen.</li>
                    <li>Hun interesserer sig (i / for) kunst.</li>
                    <li>Vi taler (om / med) problemet.</li>
                    <li>Kan jeg regne (med / på) dig?</li>
                    <li>Han leder (efter / om) sine nøgler.</li>
                    <li>Hun spurgte (efter / om) prisen.</li>
                    <li>Bogen handler (om / med) en familie.</li>
                    <li>Jeg tænker (på / over) dig.</li>
                </ol>
            </section>
        `
    },
    {
        ...
        content: `
            <section class="grammar-exercise">
                <h3>F. Adjektiv + præposition</h3>
                <ol>
                    <li>Hun er glad ___ gaven.</li>
                    <li>Jeg er interesseret ___ dansk.</li>
                    <li>Han er vred ___ sin bror.</li>
                    <li>Hun er vred ___ beslutningen.</li>
                    <li>Vi er klar ___ at gå.</li>
                    <li>Jeg er enig ___ dig.</li>
                    <li>De er stolte ___ deres børn.</li>
                </ol>
            </section>
            <section class="grammar-exercise">
                <h3>G. Pronomenform</h3>
                <ol>
                    <li>Kom med (jeg / mig).</li>
                    <li>Hun venter på (han / ham).</li>
                    <li>Brevet er til (hun / hende).</li>
                    <li>De bor ved siden af (vi / os).</li>
                    <li>Mellem dig og (jeg / mig) er det en hemmelighed.</li>
                    <li>Jeg arbejder sammen med (de / dem).</li>
                </ol>
            </section>
            <section class="grammar-exercise">
                <h3>H. Adverbial eller præpositionsobjekt?</h3>
                <ol>
                    <li>Hun bor i København.</li>
                    <li>Hun tænker på København.</li>
                    <li>Peter venter på sin ven.</li>
                    <li>Peter venter på stationen.</li>
                    <li>Toget kommer om en time.</li>
                </ol>
            </section>
            <section class="grammar-exercise">
                <h3>I. Ret fejlene</h3>
                <ol>
                    <li>Jeg bor på Danmark.</li>
                    <li>Vi ses i mandag.</li>
                    <li>Han kommer i en time.</li>
                    <li>Jeg har boet her siden fire år.</li>
                    <li>Hun er interesseret på musik.</li>
                    <li>Jeg venter til min ven.</li>
                    <li>Jeg går til hjem nu.</li>
                    <li>Mellem dig og jeg er der ingen problemer.</li>
                </ol>
            </section>
            <section class="grammar-exercise">
                <h3>J. Skriv selv</h3>
                <p>Skriv én sætning med hver: sted, retning, tid, verbum + præposition og adjektiv + præposition.</p>
                <p class="grammar-english" lang="en"><em>Write one sentence for each category.</em></p>
            </section>
        `
    },
    {
        ...
        content: `
            <section class="grammar-exercise">
                <h3>A. Præposition og styrelse</h3>
                <ol>
                    <li>på – det store bord</li>
                    <li>med – sin søster</li>
                    <li>efter – arbejdet</li>
                    <li>for – at flyve</li>
                    <li>på – om hun kommer</li>
                </ol>
            </section>
            <section class="grammar-exercise">
                <h3>B. I, på, hos eller ved?</h3>
            ...
            <section class="grammar-exercise">
                ...
                <ol>
                    <li>på fredag</li>
                    <li>om ti minutter</li>
                    <li>i tre år</li>
                    <li>for to år siden</li>
                    <li>siden januar</li>
                    <li>fra klokken 8 til 16</li>
                    <li>på to dage</li>
                </ol>
            </section>
            <section class="grammar-exercise">
                ...
                <ol>
                    <li>vente på</li>
                    <li>interessere sig for</li>
                    <li>tale om</li>
                    <li>regne med</li>
                    <li>lede efter</li>
                    <li>spørge om prisen</li>
                    <li>handle om</li>
                    <li>tænke på dig</li>
                </ol>
            </section>
    ...
    },
    {
        ...
        content: `
            <section class="grammar-exercise">
                ...
                <ol>
                    <li>glad for</li>
                    <li>interesseret i</li>
                    <li>vred på sin bror</li>
                    <li>vred over beslutningen</li>
                    <li>klar til</li>
                    <li>enig med</li>
                    <li>stolte af</li>
                </ol>
            ...
            <section class="grammar-exercise">
                <h3>H. Adverbial eller præpositionsobjekt?</h3>
                <ol>
                    <li>i København – stedsadverbial</li>
                    <li>på København – præpositionsobjekt til tænke på</li>
                    <li>på sin ven – præpositionsobjekt til vente på</li>
                    <li>på stationen – stedsadverbial</li>
                    <li>om en time – tidsadverbial</li>
                </ol>
            </section>
            <section class="grammar-exercise">
                <h3>I. Ret fejlene</h3>
                <ol>
                    <li>Jeg bor i Danmark.</li>
                    <li>Vi ses på mandag.</li>
                    <li>Han kommer om en time.</li>
                    <li>Jeg har boet her i fire år.</li>
                    <li>Hun er interesseret i musik.</li>
                    <li>Jeg venter på min ven.</li>
                    <li>Jeg går hjem nu.</li>
                    <li>Mellem dig og mig er der ingen problemer.</li>
                </ol>
            </section>
        `
    },
    {
        ...
        content: `
            <table class="grammar-example-table grammar-preposition-table">
                ...
                <tbody>
                    <tr>
                        <td>præposition / forholdsord</td>
                        <td class="grammar-english" lang="en"><em>preposition</em></td>
                        <td>viser et forhold mellem led</td>
                    </tr>
                    <tr>
                        <td>styrelse</td>
                        <td class="grammar-english" lang="en"><em>complement</em></td>
                        <td>ord eller gruppe efter præpositionen</td>
                    </tr>
                    <tr>
                        <td>præpositionsled</td>
                        <td class="grammar-english" lang="en"><em>prepositional phrase</em></td>
                        <td>præposition + styrelse</td>
                    </tr>
                    <tr>
                        <td>stedsadverbial</td>
                        <td class="grammar-english" lang="en"><em>place adverbial</em></td>
                        <td>fortæller hvor</td>
                    </tr>
                    <tr>
                        <td>tidsadverbial</td>
                        <td class="grammar-english" lang="en"><em>time adverbial</em></td>
                        <td>fortæller hvornår</td>
                    </tr>
                    <tr>
                        <td>præpositionsobjekt</td>
                        <td class="grammar-english" lang="en"><em>prepositional object</em></td>
                        <td>fast led efter et verbum</td>
                    </tr>
                    <tr>
                        <td>retning</td>
                        <td class="grammar-english" lang="en"><em>direction</em></td>
                        <td>fortæller hvorhen eller hvorfra</td>
                    </tr>
                    <tr>
                        <td>varighed</td>
                        <td class="grammar-english" lang="en"><em>duration</em></td>
                        <td>fortæller hvor længe</td>
                    </tr>
                    <tr>
                        <td>fast forbindelse</td>
                        <td class="grammar-english" lang="en"><em>fixed combination</em></td>
                        <td>ord der normalt bruges sammen</td>
                    </tr>
                    <tr>
                        <td>objektform</td>
                        <td class="grammar-english" lang="en"><em>object form</em></td>
                        <td>mig, dig, ham, hende, os, jer, dem</td>
                    </tr>
                </tbody>
            </table>
            <aside class="grammar-tip">
