...
const adjektivGrammarPages = [
    {
        ...
        content: `
            <p lang="da">
                Et adjektiv beskriver en person, en ting, et sted eller en tilstand. Det fortæller for eksempel, hvordan nogen eller
            ...
            <aside class="grammar-tip">
                <p lang="da">
                    <strong>Husk:</strong> Adjektivet bøjes ofte, så det passer til substantivets køn, tal og bestemthed.
                </p>
                <p class="grammar-english" lang="en">
                    <em>Remember: The adjective often changes to agree with the noun's gender, number, and definiteness.</em>
                </p>
            </aside>
        `
    },

    {
        ...
        content: `
            <p lang="da">
                I ubestemt form ental står adjektivet normalt i grundform efter en-ord og får <strong>-t</strong> efter et-ord. I
            ...
            <table class="grammar-noun-table grammar-comparison-table">
                ...
                <tbody>
                    <tr class="grammar-comparison-forms">
                        <td lang="da">en <u>stor</u> bil</td>
                        <td lang="da">et <u>stort</u> hus</td>
                        <td lang="da"><u>store</u> biler og huse</td>
                    </tr>
                    <tr class="grammar-comparison-meaning">
                        <td colspan="3" class="grammar-english" lang="en">
                            <em>a big car · a big house · big cars and houses</em>
                        </td>
                    </tr>
                    <tr class="grammar-comparison-forms">
                        <td lang="da">en <u>grøn</u> stol</td>
                        <td lang="da">et <u>grønt</u> bord</td>
                        <td lang="da"><u>grønne</u> stole og borde</td>
                    </tr>
                    <tr class="grammar-comparison-meaning">
                        <td colspan="3" class="grammar-english" lang="en">
                            <em>a green chair · a green table · green chairs and tables</em>
                        </td>
                    </tr>
                </tbody>
            </table>
...

    {
        ...
        content: `
            ...
            <aside class="grammar-rule">
                ...
                <p class="grammar-english" lang="en">
                    <em>Pattern: den/det/de + adjective ending in -e + noun in the definite form.</em>
                </p>
            </aside>
        `
    },

    {
        ...
        content: `
            ...
            <aside class="grammar-tip">
                ...
                <p class="grammar-english" lang="en">
                    <em>Good method: Write new adjectives in three forms, for example grøn – grønt – grønne.</em>
                </p>
            </aside>
        `
    },
...

    {
        ...
        content: `
            ...
            <aside class="grammar-rule">
                ...
                <p class="grammar-english" lang="en">
                    <em>Ask: Does the word describe a thing or person, or does it describe an action?</em>
                </p>
            </aside>
        `
    },

    {
        ...
        content: `
            ...
            <table class="grammar-noun-table grammar-example-table">
                ...
                <tbody>
                    <tr>
                        <td lang="da"><strong>glad for</strong></td>
                        <td lang="da">Jeg er <u>glad for </u> mit arbejde.</td>
                        <td class="grammar-english" lang="en"><em>I am happy with my job.</em></td>
                    </tr>
                    <tr>
                        <td lang="da"><strong>interesseret i</strong></td>
                        <td lang="da">Hun er <u>interesseret i</u> musik.</td>
                        <td class="grammar-english" lang="en"><em>She is interested in music.</em></td>
                    </tr>
                    <tr>
                        <td lang="da"><strong>bange for</strong></td>
                        <td lang="da">Barnet er <u>bange for</u> hunden.</td>
                        <td class="grammar-english" lang="en"><em>The child is afraid of the dog.</em></td>
                    </tr>
                    <tr>
                        <td lang="da"><strong>god til</strong></td>
                        <td lang="da">Han er <u>god til</u> dansk.</td>
                        <td class="grammar-english" lang="en"><em>He is good at Danish.</em></td>
                    </tr>
                    <tr>
                        <td lang="da"><strong>træt af</strong></td>
                        <td lang="da">Vi er <u>trætte af</u> regnen.</td>
                        <td class="grammar-english" lang="en"><em>We are tired of the rain.</em></td>
                    </tr>
                </tbody>
            </table>
        `
        ...
        content: `
            ...
            <table class="grammar-noun-table grammar-exercise-table grammar-exercise-table--numbered">
                ...
                <tbody>
                    <tr>
                        <td>1</td>
                        <td lang="da">Hun har en ___ jakke. (varm)</td>
                        <td></td>
                    </tr>
                    <tr>
                        <td>2</td>
                        <td lang="da">De bor i et ___ hus. (gammel)</td>
                        <td></td>
                    </tr>
                    <tr>
                        <td>3</td>
                        <td lang="da">Vi købte to ___ stole. (grøn)</td>
                        <td></td>
                    </tr>
                    <tr>
                        <td>4</td>
                        <td lang="da">Det ___ barn sover. (lille)</td>
                        <td></td>
                    </tr>
                    <tr>
                        <td>5</td>
                        <td lang="da">Opgaverne er ___. (svær)</td>
                        <td></td>
                    </tr>
                </tbody>
            </table>
...

    {
        ...
        content: `
            ...
            <table class="grammar-noun-table grammar-exercise-table grammar-exercise-table--numbered">
                ...
                <tbody>
                    <tr>
                        <td>1</td>
                        <td>varm</td>
                        <td lang="da">en-ord, ental</td>
                    </tr>
                    <tr>
                        <td>2</td>
                        <td>gammelt</td>
                        <td lang="da">et-ord, ental</td>
                    </tr>
                    <tr>
                        <td>3</td>
                        <td>grønne</td>
                        <td lang="da">flertal</td>
                    </tr>
                    <tr>
                        <td>4</td>
                        <td>lille</td>
                        <td lang="da">særlig form</td>
                    </tr>
                    <tr>
                        <td>5</td>
                        <td>svære</td>
                        <td lang="da">flertal efter være</td>
                    </tr>
                </tbody>
            </table>
            ...
            <ol>
                <li>
                    <p lang="da"><strong>mere interessant</strong> – komparativ med mere</p>
                </li>
                <li>
                    <p lang="da"><strong>hurtigste</strong> – bestemt superlativ efter den</p>
                </li>
                <li>
                    <p lang="da"><strong>bedre</strong> – uregelmæssig komparativ</p>
                </li>
                <li>
                    <p lang="da"><strong>mindste</strong> – bestemt superlativ</p>
                </li>
                <li>
                    <p lang="da"><strong>hurtigt</strong> – adjektivet passer til et-ordet toget</p>
                </li>
                <li>
                    <p lang="da"><strong>hurtigt</strong> – adverbium, som beskriver kører</p>
                </li>
                <li>
                    <p lang="da"><strong>tydeligt</strong> – adverbium, som beskriver taler</p>
                </li>
                <li>
                    <p lang="da"><strong>tydelig</strong> – adjektiv, som beskriver forklaring</p>
                </li>
            </ol>
            <p class="grammar-english" lang="en">
                <em>Review the agreement, comparison, and adjective/adverb rules if an answer was difficult.</em>
            </p>
        `
    }
];
