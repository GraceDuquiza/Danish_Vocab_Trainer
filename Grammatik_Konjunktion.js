...
const konjunktionGrammarPages = [
        ...
        content: `
            ...
            <table class="grammar-example-table">
                ...
                <tbody>
                    <tr>
                        <td>Substantiver</td>
                        <td>kaffe <u>eller</u> te</td>
                        <td class="grammar-english" lang="en"><em>coffee or tea</em></td>
                    </tr>
                    <tr>
                        <td>Adjektiver</td>
                        <td>gammel <u>og</u> træt</td>
                        <td class="grammar-english" lang="en"><em>old and tired</em></td>
                    </tr>
                    <tr>
                        <td>Verber</td>
                        <td>De sidder <u>og</u> snakker.</td>
                        <td class="grammar-english" lang="en"><em>They sit and talk.</em></td>
                    </tr>
                    <tr>
                        <td>Hovedsætninger</td>
                        <td>Hun arbejder, <u>og</u> han studerer.</td>
                        <td class="grammar-english" lang="en"><em>She works, and he studies.</em></td>
                    </tr>
                </tbody>
            </table>
    ...
    },
    {
        ...
        content: `
            ...
            <div class="grammar-example">
                <p lang="da">… <u>fordi</u> jeg er træt.</p>
            ...
            <table class="grammar-bilingual-table">
                ...
                <tbody>
                    <tr>
                        <td>Kun hovedsætning</td>
                        <td>Jeg bliver hjemme.</td>
                    </tr>
                    <tr>
                        <td>Hovedsætning + ledsætning</td>
                        <td>Jeg bliver hjemme, <u>fordi</u> jeg er træt.</td>
                    </tr>
                    <tr>
                        <td>Ledsætning + hovedsætning</td>
                        <td><u>Hvis</u> det regner, bliver vi hjemme.</td>
                    </tr>
                    <tr>
                        <td>Hovedsætning + to ledsætninger</td>
                        <td>Hun tænkte, <u>at</u> der var lang tid til, <u>at</u> hun fik ferie.</td>
                    </tr>
                </tbody>
            </table>
        `
    },
    {
        ...
        content: `
            <p lang="da">
                Sideordnende konjunktioner forbinder to led eller sætninger på samme grammatiske niveau. De mest almindelige er
            ...
            <aside class="grammar-tip">
                <p lang="da">
                    Nogle materialer behandler <strong>for</strong> og <strong>så</strong> som en særlig samordnende undergruppe.
    ...
    },
    {
        ...
        titleEn: "For and så",
        content: `
            <h3>For / For, because</h3>
            <p lang="da">
                <strong>For</strong> indleder en forklarende hovedsætning. Betydningen ligner ofte <strong>fordi</strong>, men efter
            ...
            <h3>Så / So</h3>
            <p lang="da">
                <strong>Så</strong> viser resultatet af den første sætning. Det kan ofte erstattes af adverbiet
            ...
            <table class="grammar-example-table">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>derfor</td>
                        <td>adverbium</td>
                        <td>Det regnede. <u>Derfor</u> blev vi hjemme.</td>
                    </tr>
                </tbody>
            </table>
            <aside class="grammar-tip">
        ...
        content: `
            ...
            <table class="grammar-example-table grammar-conjunction-table">
                ...
                <tbody>
                    <tr>
                        <td>selvom</td>
                        <td class="grammar-english" lang="en"><em>although</em></td>
                        <td>Hun cyklede, <u>selvom</u> det regnede.</td>
                    </tr>
                    <tr>
                        <td>skønt</td>
                        <td class="grammar-english" lang="en"><em>although</em></td>
                        <td><u>Skønt</u> han var træt, fortsatte han.</td>
                    </tr>
                    <tr>
                        <td>om end</td>
                        <td class="grammar-english" lang="en"><em>although</em></td>
                        <td>Opgaven er svær, <u>om end</u> interessant.</td>
                    </tr>
                    <tr>
                        <td>til trods for at</td>
                        <td class="grammar-english" lang="en"><em>despite the fact that</em></td>
                        <td>De kom, <u>til trods for at</u> vejret var dårligt.</td>
                    </tr>
                    <tr>
                        <td>hvorimod</td>
                        <td class="grammar-english" lang="en"><em>whereas</em></td>
                        <td>Hun elsker kaffe, <u>hvorimod</u> han foretrækker te.</td>
                    </tr>
                    <tr>
                        <td>hvad enten … eller</td>
                        <td class="grammar-english" lang="en"><em>whether … or</em></td>
                        <td>Vi tager af sted, <u>hvad enten</u> det regner <u>eller</u> sner.</td>
                    </tr>
                </tbody>
            </table>
            <aside class="grammar-tip">
    ...
    },
    {
        ...
        content: `
            ...
            <aside class="grammar-tip">
                <p lang="da">
                    Samme subjekt: ofte <strong>for at + navnemåde</strong>. Tydeligt subjekt i formålsledsætningen:
                    <strong>så at</strong>.
                </p>
                <p class="grammar-english" lang="en">
                    <em
    ...
    },
    {
        ...
        content: `
            ...
            <table class="grammar-example-table">
                <thead>
                    <tr>
                        <th><strong>Konstruktion</strong></th>
                        <th lang="da">Dansk</th>
                        <th class="grammar-english" lang="en">English</th>
                    </tr>
                </thead>
    ...
    },
    {
        ...
        content: `
            ...
            <table class="grammar-bilingual-table">
                ...
                <tbody>
                    <tr>
                        <td>Der som subjekt</td>
                        <td>En pige, <u>der</u> arbejder i banken.</td>
                    </tr>
                    <tr>
                        <td>Som som subjekt</td>
                        <td>En pige, <u>som</u> arbejder i banken.</td>
                    </tr>
                    <tr>
                        <td>Som som objekt</td>
                        <td>Bogen, <u>som</u> jeg købte i går.</td>
                    </tr>
                    <tr>
                        <td>Som efter præposition</td>
                        <td>Personen, <u>som</u> jeg talte med.</td>
                    </tr>
                </tbody>
            </table>
...

    {
        ...
        content: `
            ...
            <div class="grammar-legend grammar-local-legend" aria-label="Grammar color guide">
                ...
                <span>
                    <span class="legend-dot conjunction"></span>
                    Konjunktion (K)
                </span>
            </div>
            ...
            <table class="grammar-example-table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            …
                            <u><span class="conjunction">fordi</span></u>
                            <span class="subject">han</span>
                            <span class="adverb">ikke</span>
                            <span class="verb-v1">kommer</span>.
                        </td>
...

    {
        ...
        content: `
            ...
            <table class="grammar-bilingual-table">
                ...
                <tbody>
                    <tr>
                        <td>To hovedsætninger</td>
                        <td>Hun laver mad, <u>og</u> han vasker op.</td>
                    </tr>
                    <tr>
                        <td>Hovedsætning + ledsætning</td>
                        <td>Jeg bliver hjemme, <u>fordi</u> jeg er syg.</td>
                    </tr>
                    <tr>
                        <td>Ledsætning + hovedsætning</td>
                        <td><u>Hvis</u> det regner, bliver vi hjemme.</td>
                    ...
                    <tr>
                        <td>To led, ikke to sætninger</td>
                        <td>Hun vaskede <u>og</u> strøg tøjet.</td>
                    </tr>
                    <tr>
                        <td>Opremsning</td>
                        <td>Hun købte brød, mælk <u>og</u> ost.</td>
                    </tr>
                </tbody>
            </table>
            <aside class="grammar-tip">
    ...
    },
    {
        ...
        content: `
            <table class="grammar-correction-table grammar-correction-table--paired">
                ...
                <tbody>
                    <tr>
                        <td class="grammar-result grammar-result--incorrect">… fordi jeg er ikke rask.</td>
                        <td class="grammar-result grammar-result--correct">… fordi jeg ikke er rask.</td>
                    </tr>
                    ...
                    <tr>
                        <td class="grammar-result grammar-result--incorrect">Jeg ved ikke, at han kommer.</td>
                        <td class="grammar-result grammar-result--correct">Jeg ved ikke, om han kommer.</td>
                    </tr>
                    <tr class="grammar-correction-reason">
                        <td colspan="2">
                    ...
                    <tr>
                        <td class="grammar-result grammar-result--incorrect">… for jeg ikke har tid.</td>
                        <td class="grammar-result grammar-result--correct">… for jeg har ikke tid.</td>
                    </tr>
                    <tr class="grammar-correction-reason">
                        <td colspan="2">
                    ...
                    <tr>
                        <td class="grammar-result grammar-result--incorrect">Medmindre det ikke regner …</td>
                        <td class="grammar-result grammar-result--correct">Medmindre det regner …</td>
                    </tr>
                    <tr class="grammar-correction-reason">
                        <td colspan="2">
                    ...
                    <tr>
                        <td class="grammar-result grammar-result--incorrect">Han talte så hurtigt, fordi jeg ikke forstod ham.</td>
                        <td class="grammar-result grammar-result--correct">Han talte så hurtigt, at jeg ikke forstod ham.</td>
                    </tr>
                    <tr class="grammar-correction-reason">
                        <td colspan="2">
                    ...
                    <tr>
                        <td class="grammar-result grammar-result--incorrect">Jeg læser, fordi at jeg vil lære.</td>
                        <td class="grammar-result grammar-result--correct">Jeg læser, fordi jeg vil lære.</td>
                    </tr>
                    <tr class="grammar-correction-reason">
                        <td colspan="2">
...

    {
        ...
        content: `
            <section class="grammar-exercise">
                <h3>A. Find konjunktionerne / Find the conjunctions</h3>
                <p>Understreg bindeordene, og skriv, hvad de forbinder.</p>
                <ol>
                    <li>Peter og Ulla arbejder sammen.</li>
                    <li>Jeg vil gerne med, men jeg har ikke tid.</li>
                    <li>Hun bliver hjemme, fordi hun er syg.</li>
                    <li>Hvis vejret er godt, tager vi på stranden.</li>
                    <li>Jeg ved ikke, om han kommer.</li>
                </ol>
            </section>
            <section class="grammar-exercise">
                <h3>B. Vælg og, men eller eller</h3>
                <ol>
                    <li>Vil du have kaffe ___ te?</li>
                    <li>Hun er træt, ___ hun fortsætter.</li>
                    <li>Peter ___ Maria kommer til festen.</li>
                    <li>Skynd dig, ___ vi kommer for sent.</li>
                    <li>Skal vi gå, ___ skal vi tage bussen?</li>
                </ol>
            </section>
            <section class="grammar-exercise">
                <h3>C. Vælg for, fordi eller så</h3>
                <ol>
                    <li>Jeg går hjem, ___ jeg har ikke mere tid.</li>
                    <li>Jeg går hjem, ___ jeg ikke har mere tid.</li>
                    <li>Hun var syg, ___ hun blev hjemme.</li>
                    <li>Vi tog en taxa, ___ det ikke var muligt at få en bus.</li>
                    <li>Det regnede, ___ kampen blev aflyst.</li>
                </ol>
            </section>
            <section class="grammar-exercise">
                <h3>D. At eller om?</h3>
                <ol>
                    <li>Jeg tror, ___ han kommer.</li>
                    <li>Jeg ved ikke, ___ han kommer.</li>
                    <li>Hun spørger, ___ vi har tid.</li>
                    <li>Vi håber, ___ vejret bliver godt.</li>
                    <li>Kan du huske, ___ døren er låst?</li>
                </ol>
            </section>
        `
    },
    {
        ...
        content: `
            <section class="grammar-exercise">
                <h3>E. Vælg et tidsbindeord / Choose a time conjunction</h3>
                <ol>
                    <li>___ jeg var barn, boede jeg på landet. (da / når)</li>
                    <li>___ jeg kommer hjem, ringer jeg. (da / når)</li>
                    <li>Jeg læser, ___ du laver mad. (mens / fordi)</li>
                    <li>Vent her, ___ jeg kommer tilbage. (indtil / selvom)</li>
                    <li>Vi gik, ___ filmen var slut. (efter at / hvis)</li>
                </ol>
            </section>
            <section class="grammar-exercise">
                <h3>F. Betingelse eller indrømmelse</h3>
                <ol>
                    <li>___ det regner, bliver vi hjemme. (hvis / selvom)</li>
                    <li>Vi går tur, ___ det regner. (selvom / fordi)</li>
                    <li>Du kan komme med, ___ du er klar. (hvis / mens)</li>
                    <li>Vi tager af sted, ___ bussen er forsinket. (selvom / så)</li>
                    <li>Jeg køber ikke bilen, ___ prisen bliver lavere. (medmindre / fordi)</li>
                </ol>
            </section>
            <section class="grammar-exercise">
                <h3>G. Ret ordstillingen / Correct the word order</h3>
                <ol>
                    <li>Jeg bliver hjemme, fordi jeg er ikke rask.</li>
                    <li>Hvis hun har tid, hun kommer i morgen.</li>
                    <li>Jeg går hjem, for jeg ikke kan vente.</li>
                    <li>Hun siger, at hun kommer måske senere.</li>
                    <li>Vi tager en taxa, hvis bussen kommer ikke.</li>
                </ol>
            </section>
            <section class="grammar-exercise">
                <h3>H. Forbind sætningerne / Join the sentences</h3>
                <ol>
                    <li>Jeg er træt. Jeg arbejder videre. (men)</li>
                    <li>Det regner. Vi bliver hjemme. (så)</li>
                    <li>Hun kommer ikke. Hun er syg. (fordi)</li>
                    <li>Du ringer. Jeg hjælper dig. (hvis)</li>
                    <li>Han var nervøs. Han holdt en god tale. (selvom)</li>
                </ol>
            </section>
            <section class="grammar-exercise">
                <h3>I. Komma eller intet komma?</h3>
                <ol>
                    <li>Hun vaskede ___ og strøg tøjet.</li>
                    <li>Hun vaskede tøjet ___ og han strøg det.</li>
                    <li>Hvis det regner ___ bliver vi hjemme.</li>
                    <li>Jeg køber brød ___ mælk og ost.</li>
                    <li>Jeg kommer ___ når jeg er færdig.</li>
                </ol>
            </section>
        `
    },
    {
        ...
        content: `
            <section class="grammar-exercise">
                <h3>A. Find konjunktionerne</h3>
                <ol>
                    <li><strong>og</strong> forbinder Peter og Ulla.</li>
                    <li><strong>men</strong> forbinder to hovedsætninger.</li>
                    <li><strong>fordi</strong> indleder en årsagsledsætning.</li>
                    <li><strong>hvis</strong> indleder en betingelsesledsætning.</li>
                    <li><strong>om</strong> indleder et indirekte ja/nej-spørgsmål.</li>
                </ol>
            </section>
            <section class="grammar-exercise">
                <h3>B. Og, men eller eller</h3>
                <ol>
                    <li>eller</li>
                    <li>men</li>
                    <li>og</li>
            ...
            <section class="grammar-exercise">
                <h3>C. For, fordi eller så</h3>
                <ol>
                    <li><strong>for</strong>: hovedsætningsordstilling.</li>
                    <li><strong>fordi</strong>: ledsætningsordstilling.</li>
                    <li><strong>så</strong>: resultat.</li>
                    <li><strong>fordi</strong> (for kan bruges med ændret ordstilling og stil).</li>
                    <li><strong>så</strong>: resultat.</li>
                </ol>
            </section>
            <section class="grammar-exercise">
    ...
    },
    {
        ...
        content: `
            <section class="grammar-exercise">
                <h3>E. Tidsbindeord</h3>
                <ol>
                    <li>Da jeg var barn …</li>
                    <li>Når jeg kommer hjem …</li>
                    <li>mens</li>
                    <li>indtil</li>
                    <li>efter at</li>
                </ol>
            ...
            <section class="grammar-exercise">
                <h3>G. Ret ordstillingen</h3>
                <ol>
                    <li>Jeg bliver hjemme, fordi jeg ikke er rask.</li>
                    <li>Hvis hun har tid, kommer hun i morgen.</li>
                    <li>Jeg går hjem, for jeg kan ikke vente.</li>
                    <li>Hun siger, at hun måske kommer senere.</li>
                    <li>Vi tager en taxa, hvis bussen ikke kommer.</li>
                </ol>
            </section>
            <section class="grammar-exercise">
                <h3>H. Forbind sætningerne</h3>
                <ol>
                    <li>Jeg er træt, men jeg arbejder videre.</li>
                    <li>Det regner, så vi bliver hjemme.</li>
                    <li>Hun kommer ikke, fordi hun er syg.</li>
                    <li>Hvis du ringer, hjælper jeg dig.</li>
                    <li>Selvom han var nervøs, holdt han en god tale.</li>
                </ol>
            </section>
            <section class="grammar-exercise">
                <h3>I. Komma eller intet komma?</h3>
                <ol>
                    <li>Intet komma: Hun vaskede og strøg tøjet.</li>
                    <li>Komma: Hun vaskede tøjet, og han strøg det.</li>
                    <li>Komma: Hvis det regner, bliver vi hjemme.</li>
                    <li>Intet komma før og: Jeg køber brød, mælk og ost.</li>
                    <li>Komma: Jeg kommer, når jeg er færdig.</li>
                </ol>
            </section>
        `
    },
    {
        ...
        content: `
            <table class="grammar-example-table">
                ...
                <tbody>
                    <tr>
                        <td>konjunktion / bindeord</td>
                        <td class="grammar-english" lang="en"><em>conjunction</em></td>
                        <td>forbinder ord, led eller sætninger</td>
                    </tr>
                    <tr>
                        <td>sideordnende</td>
                        <td class="grammar-english" lang="en"><em>coordinating</em></td>
                        <td>forbinder led på samme niveau</td>
                    </tr>
                    <tr>
                        <td>underordnende</td>
                        <td class="grammar-english" lang="en"><em>subordinating</em></td>
                        <td>indleder en ledsætning</td>
                    </tr>
                    <tr>
                        <td>hovedsætning</td>
                        <td class="grammar-english" lang="en"><em>main clause</em></td>
                        <td>kan normalt stå alene</td>
                    </tr>
                    <tr>
                        <td>ledsætning</td>
                        <td class="grammar-english" lang="en"><em>subordinate clause</em></td>
                        <td>er underordnet en hovedsætning</td>
                    </tr>
                    <tr>
                        <td>helsætning</td>
                        <td class="grammar-english" lang="en"><em>complete sentence</em></td>
                        <td>indeholder mindst én hovedsætning</td>
                    </tr>
                    <tr>
                        <td>tidskonjunktion</td>
                        <td class="grammar-english" lang="en"><em>time conjunction</em></td>
                        <td>viser tidspunkt eller rækkefølge</td>
                    </tr>
                    <tr>
                        <td>årsagskonjunktion</td>
                        <td class="grammar-english" lang="en"><em>causal conjunction</em></td>
                        <td>forklarer hvorfor</td>
                    </tr>
                    <tr>
                        <td>betingelseskonjunktion</td>
                        <td class="grammar-english" lang="en"><em>conditional conjunction</em></td>
                        <td>viser en betingelse</td>
                    </tr>
                    <tr>
                        <td>indrømmelse</td>
                        <td class="grammar-english" lang="en"><em>concession</em></td>
                        <td>ændrer ikke resultatet</td>
                    </tr>
                    <tr>
                        <td>formål</td>
                        <td class="grammar-english" lang="en"><em>purpose</em></td>
                        <td>viser et mål</td>
                    </tr>
                    <tr>
                        <td>følge</td>
                        <td class="grammar-english" lang="en"><em>result</em></td>
                        <td>viser en konsekvens</td>
                    </tr>
                    <tr>
                        <td>inversion</td>
                        <td class="grammar-english" lang="en"><em>inversion</em></td>
                        <td>finit verbum før subjektet</td>
                    </tr>
                    <tr>
                        <td>centraladverbium</td>
                        <td class="grammar-english" lang="en"><em>central adverb</em></td>
                        <td>fx ikke, altid, aldrig, måske</td>
                    </tr>
                </tbody>
            </table>
            <aside class="grammar-tip">
