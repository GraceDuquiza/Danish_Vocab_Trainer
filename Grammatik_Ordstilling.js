...
const ordstillingGrammarPages = [
    {
        ...
        content: `
            ...
            <table class="grammar-example-table">
                <thead>
                    <tr>
                        <th class="grammar-shared-column">Fokus / Focus</th>
                        <th class="grammar-danish-column" lang="da">Dansk</th>
                        <th class="grammar-english-column" lang="en">English</th>
                    </tr>
                </thead>
                <tbody>
                    <tr>
    ...
    },
    {
        ...
        content: `
            ...
            <table class="grammar-example-table">
                <thead>
                    <tr>
                        <th class="grammar-shared-column">Led / Element</th>
                        <th class="grammar-danish-column" lang="da">Dansk funktion</th>
                        <th class="grammar-english-column" lang="en">English function</th>
                    </tr>
                </thead>
                <tbody>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td class="grammar-danish-column">verbal: hvad gør eller er subjektet?</td>
                        <td class="grammar-english-column grammar-english" lang="en">
                            <em>verb phrase: what does or is the subject?</em>
                        </td>
                    </tr>
                    <tr>
    ...
    },
    {
        ...
        content: `
            <table class="grammar-example-table">
                <thead>
                    <tr>
                        <th class="grammar-shared-column">Type</th>
                        <th class="grammar-danish-column" lang="da">Dansk</th>
                        <th class="grammar-english-column" lang="en">English</th>
                    </tr>
                </thead>
    ...
    },
    {
        ...
        content: `
            ...
            <table class="grammar-example-table">
                <thead>
                    <tr>
                        <th class="grammar-shared-column">Første plads / First position</th>
                        <th class="grammar-danish-column">Finit verbum</th>
                        <th class="grammar-english-column">Resten / Remainder</th>
                    </tr>
                </thead>
                <tbody>
                    <tr>
    ...
    },
    {
        ...
        content: `
            ...
            <table class="grammar-example-table">
                <thead>
                    <tr>
                        <th class="grammar-shared-column">Mønster / Pattern</th>
                        <th class="grammar-danish-column">Før verbalkæden</th>
                        <th class="grammar-english-column">Efter verbalkæden</th>
                    </tr>
                </thead>
                <tbody>
                    <tr>
    ...
    },
    {
        ...
        content: `
            ...
            <table class="grammar-example-table">
                <thead>
                    <tr>
                        <th class="grammar-shared-column">K + S + A + V</th>
                        <th class="grammar-danish-column">Verbalkæde</th>
                        <th class="grammar-english-column">Resten</th>
                    </tr>
                </thead>
                <tbody>
                    <tr>
    ...
    },
    {
        ...
        content: `
            ...
            <table class="grammar-bilingual-table">
                <thead>
                    <tr>
                        <th>Ledsætning først</th>
                        <th>Hovedsætning med inversion</th>
                    </tr>
                </thead>
                <tbody>
                    <tr>
                    ...
                    <tr>
                        <td>
                            ...
                            <span class="predicative">syg</span>,
                        </td>
                        <td>
                            <span class="verb-v1">kom</span>
                            <span class="subject">hun</span>
                            <span class="adverb">ikke</span>
                            <span class="adverb">på arbejde</span>.
                        </td>
                    </tr>

                    <tr>
                        <td>
                            <span class="conjunction">Selvom</span>
                            <span class="subject">han</span>
                            <span class="verb-v1">var</span>
                            <span class="predicative">træt</span>,
                        </td>
                        <td>
                            <span class="verb-v1">fortsatte</span>
                            <span class="subject">han</span>.
                        </td>
                    </tr>
                </tbody>
    ...
    },
    {
        ...
        content: `
            ...
            <table class="grammar-example-table">
                <thead>
                    <tr>
                        <th class="grammar-shared-column">Mønster</th>
                        <th class="grammar-danish-column">Start</th>
                        <th class="grammar-english-column">Resten</th>
                    </tr>
                </thead>
                <tbody>
            ...
            <h3>Hv-spørgsmål / Wh-questions</h3>
            <div class="grammar-text-pair">
                <p lang="da">
    ...
    },
    {
        ...
        content: `
            ...
            <table class="grammar-bilingual-table">
                <thead>
                    <tr>
                        <th>Direkte spørgsmål</th>
                        <th>Indirekte spørgsmål</th>
                    </tr>
                </thead>
                <tbody>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <span class="verb-v1">ved</span>
                            <span class="adverb">ikke</span>,
                            <span class="conjunction">om</span>
                            <span class="subject">hun</span>
                            <span class="verb-v1">kommer</span>
                            <span class="adverb">i morgen</span>.
                        </td>
                    ...
                    <tr>
                        <td>
                            <span class="adverb">Hvorfor</span>
                        ...
                        <td>
                            ...
                            <span class="subject">du</span>
                            <span class="verb-v2">forklare</span>,
                            <span class="conjunction">hvorfor</span>
                            <span class="subject">han</span>
                            <span class="adverb">ikke</span>
                            <span class="verb-v1">er</span>
                            <span class="adverb">her</span>?
        ...
        content: `
            ...
            <table class="grammar-example-table">
                <thead>
                    <tr>
                        <th class="grammar-shared-column">Mønster</th>
                        <th class="grammar-danish-column">Dansk</th>
                        <th class="grammar-english-column">English</th>
                    </tr>
                </thead>
                <tbody>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td class="grammar-danish-column">
                            ...
                            <span class="verb-v1">har</span>
                            <span class="adverb">ikke</span>
                            <span class="verb-v2">købt</span>
                            <span class="object">bilen</span>.
                        </td>
                    ...
                    <tr>
                        ...
                        <td class="grammar-danish-column">
                            <span class="subject">Hun</span>
                            <span class="verb-v1">gav</span>
                            <span class="indirectobject">sin søster</span>
                            <span class="object">en bog</span>.
                        </td>
    ...
    },
    {
        ...
        content: `
            ...
            <table class="grammar-bilingual-table">
                <thead>
                    <tr>
                        <th>Substantivisk objekt</th>
                        <th>Pronominalt objekt</th>
                    </tr>
                </thead>
                <tbody>
                    <tr>
                        <td>
                            <span class="subject">Jeg</span>
                            <span class="verb-v1">ser</span>
                            <span class="adverb">ikke</span>
                            <span class="object">Peter</span>.
                        </td>
                    ...
                    <tr>
                        <td>
                            <span class="subject">Vi</span>
                            <span class="verb-v1">møder</span>
                            <span class="adverb">sjældent</span>
                            <span class="object">naboerne</span>.
                        </td>
                    ...
                    <tr>
                        <td>
                            <span class="subject">Hun</span>
                            <span class="verb-v1">viste</span>
                            <span class="adverb">ikke</span>
                            <span class="indirectobject">sin søster</span>
                            <span class="object">billederne</span>.
                        </td>

                        <td>
                            <span class="subject">Hun</span>
                            <span class="verb-v1">viste</span>
                            <span class="indirectobject">hende</span>
                            <span class="object">dem</span>
                            <span class="adverb">ikke</span>.
                        </td>
                    </tr>
    ...
    },
    {
        ...
        content: `
            <table class="grammar-example-table">
                ...
                <tbody>
                    <tr>
                        <th class="grammar-shared-column" scope="row">Subjektsprædikativ</th>
                        <td class="grammar-danish-column">
                            Beskriver subjektet:
                            <span class="subject">Huset</span>
                            <span class="verb-v1">er</span>
                            <span class="predicative">stort</span>.

                            <span class="subject">Hun</span>
                            <span class="verb-v1">blev</span>
                    ...
                    <tr>
                        <th class="grammar-shared-column" scope="row">Objektsprædikativ</th>
                        <td class="grammar-danish-column">
                            Beskriver objektet:
                            <span class="subject">Vi</span>
                            <span class="verb-v1">malede</span>
                            <span class="object">huset</span>
                ...
                <tbody>
                    <tr>
                        ...
                        <td>
                            <span class="subject">Hun</span>
                            <span class="verb-v1">er</span>
                            <span class="predicative">glad</span>.
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <span class="subject">Vi</span>
                            <span class="verb-v1">malede</span>
                            <span class="object">væggen</span>
                            <span class="object-predicative">hvid</span>.
                        </td>
                    </tr>
                </tbody>
            </table>
    ...
    },
    {
        ...
        content: `
            ...
            <table class="grammar-example-table grammar-focus-example-table">
                ...
                <tbody>
                    <tr>
                        <th scope="row" lang="da">Måde – Hvordan?</th>
                        <td class="grammar-english" lang="en"><em>Manner – How?</em></td>
                        <td>
                            <span class="subject">Hun</span>
                            <span class="verb-v1">arbejder</span>
                            <span class="adverb">koncentreret</span>.
                        </td>
                    </tr>
                    <tr>
                        <th scope="row" lang="da">Sted – Hvor?</th>
                        <td class="grammar-english" lang="en"><em>Place – Where?</em></td>
                        <td>
                            <span class="subject">Hun</span>
                            <span class="verb-v1">arbejder</span>
                    ...
                    <tr>
                        <th scope="row" lang="da">Tid – Hvornår?</th>
                        <td class="grammar-english" lang="en"><em>Time – When?</em></td>
                        <td>
                            <span class="subject">Hun</span>
                            <span class="verb-v1">arbejder</span>
                            <span class="adverb">om aftenen</span>.
                    ...
                    <tr>
                        <th scope="row" lang="da">Kombination</th>
                        <td class="grammar-english" lang="en"><em>Combination</em></td>
                        <td>
                            <span class="subject">Hun</span>
                            <span class="verb-v1">arbejder</span>
                            <span class="adverb">koncentreret</span>
                ...
                <tbody>
                    <tr>
                        ...
                        <td>
                            ...
                            <span class="object">en mand</span>,
                            <span class="subject">der</span>
                            <span class="adverb">ikke</span>
                            <span class="verb-v1">ryger</span>.
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <span class="subject">Det</span>
                            <span class="verb-v1">er</span>
                            <span class="predicative">bogen</span>,
                            <span class="object">som</span>
                            <span class="subject">jeg</span>
                            <span class="adverb">ikke</span>
                            <span class="verb-v1">har</span>
                            <span class="verb-v2">læst</span>.
...
<!-- LOCAL LEGEND -->
            <div class="grammar-legend grammar-local-legend" aria-label="Formal and real subject color guide">
                ...
                <span>
                    <span class="legend-dot real-subject"></span>
                    Real subject
                </span>
            </div>
                ...
                <tbody>
                    <tr>
                        ...
                        <td>
                            ...
                            <span class="verb-v1">er</span>
                            <span class="real-subject">en kat</span>
                    ...
                    <tr>
                        <td>
                            <span class="formal-subject">Det</span>
                            <span class="verb-v1">er</span>
                            <span class="predicative">vigtigt</span>
                            <span class="conjunction">at</span>
                            <span class="verb-v2">øve</span>
                            <span class="object">sig</span>.
                        </td>

                        <td>
                            <span class="formal-subject">Der</span>
                            <span class="verb-v1">ligger</span>
                            <span class="real-subject">en bog</span>
                            <span class="adverb">på bordet</span>.
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td>
                            <span class="formal-subject">Det</span>
                            <span class="verb-v1">er</span>
                            <span class="predicative">dejligt</span>,
                            <span class="conjunction">at</span>
                            <span class="subject">du</span>
                            <span class="verb-v1">er</span>
                            <span class="adverb">her</span>.
                        ...
                        <td>
                            <span class="formal-subject">Der</span>
                            <span class="verb-v1">bor</span>
                            <span class="real-subject">mange studerende</span>
                            <span class="adverb">her</span>.
                        </td>
                    </tr>
                </tbody>
    ...
    },
    {
        ...
        content: `
            ...
            <table class="grammar-example-table">
                <thead>
                    <tr>
                        <th class="grammar-shared-column">Kort ytring</th>
                        <th class="grammar-danish-column">Underforstået sætning</th>
                        <th class="grammar-english-column">English</th>
                    </tr>
                </thead>
                <tbody>
    ...
    },
    {
        ...
        content: `
            <table class="grammar-example-table">
                <thead>
                    <tr>
                        <th class="grammar-shared-column">Spørgsmål / Question</th>
                        <th class="grammar-danish-column">Regel / Rule</th>
                        <th class="grammar-english-column">Eksempel</th>
                    </tr>
                </thead>
                <tbody>
                    <tr>
    ...
    },
    {
        ...
        content: `
            <table class="grammar-correction-table grammar-correction-table--paired">
                <thead>
                    <tr>
                        <th>
                            <span class="grammar-paired-label">
                ...
                <tbody>
                    <tr>
                        <td class="grammar-result grammar-result--incorrect">I dag jeg arbejder hjemme.</td>
                        <td class="grammar-result grammar-result--correct">I dag arbejder jeg hjemme.</td>
                    </tr>
                    ...
                    <tr>
                        <td class="grammar-result grammar-result--incorrect">Hun ikke kommer i morgen.</td>
                        <td class="grammar-result grammar-result--correct">Hun kommer ikke i morgen.</td>
                    </tr>
                    <tr class="grammar-correction-reason">
                        <td colspan="2">
                    ...
                    <tr>
                        <td class="grammar-result grammar-result--incorrect">… fordi hun kommer ikke.</td>
                        <td class="grammar-result grammar-result--correct">… fordi hun ikke kommer.</td>
                    </tr>
                    <tr class="grammar-correction-reason">
                        <td colspan="2">
                    ...
                    <tr>
                        <td class="grammar-result grammar-result--incorrect">Hvis det regner, vi bliver hjemme.</td>
                        <td class="grammar-result grammar-result--correct">Hvis det regner, bliver vi hjemme.</td>
                    </tr>
                    <tr class="grammar-correction-reason">
                        <td colspan="2">
                    ...
                    <tr>
                        <td class="grammar-result grammar-result--incorrect">Jeg ved ikke, hvor bor han.</td>
                        <td class="grammar-result grammar-result--correct">Jeg ved ikke, hvor han bor.</td>
                    </tr>
                    <tr class="grammar-correction-reason">
                        <td colspan="2">
                    ...
                    <tr>
                        <td class="grammar-result grammar-result--incorrect">Jeg har set ikke filmen.</td>
                        <td class="grammar-result grammar-result--correct">Jeg har ikke set filmen.</td>
                    </tr>
                    <tr class="grammar-correction-reason">
                        <td colspan="2">
                    ...
                    <tr>
                        <td class="grammar-result grammar-result--incorrect">Det er mange mennesker her.</td>
                        <td class="grammar-result grammar-result--correct">Der er mange mennesker her.</td>
                    </tr>
                    <tr class="grammar-correction-reason">
                        <td colspan="2">
...

    {
        ...
        content: `
            <section class="grammar-exercise">
                <h3>A. Find subjekt og finit verbum</h3>
                <ol>
                    <li>Min ven arbejder på et hotel.</li>
                    <li>I morgen skal vi besøge København.</li>
                    <li>Hun har aldrig været i Sverige.</li>
                    <li>Når bussen kommer, stiger vi på.</li>
                    <li>Der står en mand ved døren.</li>
                </ol>
            </section>
            <section class="grammar-exercise">
                <h3>B. Ligefrem eller inversion?</h3>
                <ol>
                    <li>Jeg / arbejder / hjemme / i dag.</li>
                    <li>I dag / jeg / arbejder / hjemme.</li>
                    <li>På stationen / mange mennesker / venter.</li>
                    <li>Den film / har / jeg / ikke / set.</li>
                    <li>Heldigvis / fandt / vi / nøglerne.</li>
                </ol>
            </section>
            <section class="grammar-exercise">
                <h3>C. Placér centraladverbiet</h3>
                <ol>
                    <li>Hun kommer i morgen. (ikke)</li>
                    <li>Vi har set filmen. (aldrig)</li>
                    <li>De vil spise sammen. (gerne)</li>
                    <li>Jeg arbejder hjemme. (ofte)</li>
                    <li>Han kan forstå spørgsmålet. (måske)</li>
                </ol>
            </section>
            <section class="grammar-exercise">
            ...
            <section class="grammar-exercise">
                <h3>E. Ledsætning først</h3>
                <ol>
                    <li>Hvis det regner / vi / hjemme / bliver.</li>
                    <li>Når jeg kommer hjem / jeg / mad / laver.</li>
                    <li>Fordi hun er syg / hun / ikke / arbejder.</li>
                    <li>Selvom han var træt / han / videre / fortsatte.</li>
                </ol>
            </section>
        `
    },
    {
        ...
        content: `
            <section class="grammar-exercise">
                <h3>F. Lav spørgsmål</h3>
                <ol>
                    <li>Du kommer i morgen. → ja/nej-spørgsmål</li>
                    <li>Hun bor i Aarhus. → spørg om sted</li>
                    <li>Peter købte bilen. → spørg om objektet</li>
                    <li>Maria kommer i morgen. → spørg om subjektet</li>
                </ol>
            </section>
            <section class="grammar-exercise">
                <h3>G. Direkte til indirekte spørgsmål</h3>
                <ol>
                    <li>Hvor bor han? → Jeg ved ikke, …</li>
                    <li>Kommer hun i morgen? → Peter spørger, …</li>
                    <li>Hvorfor er de ikke her? → Kan du forklare, …</li>
                </ol>
            </section>
            <section class="grammar-exercise">
                <h3>H. Objekter</h3>
                <ol>
                    <li>Hun gav / en bog / sin søster.</li>
                    <li>Jeg ser / ikke / ham.</li>
                    <li>Vi har / dem / aldrig / mødt.</li>
                    <li>Hun viste / dem / ikke / hende.</li>
                </ol>
            </section>
            <section class="grammar-exercise">
                <h3>I. Det eller der?</h3>
                <ol>
                    <li>___ regner i dag.</li>
                    <li>___ står en bil udenfor.</li>
                    <li>___ er vigtigt at læse hver dag.</li>
                    <li>I haven ligger ___ en bold.</li>
                </ol>
            </section>
            <section class="grammar-exercise">
                <h3>J. Ret fejlene</h3>
                <ol>
                    <li>I morgen jeg skal arbejde.</li>
                    <li>Hun ikke har tid.</li>
                    <li>Jeg tror, at hun kommer ikke.</li>
                    <li>Hvis han ringer, jeg svarer.</li>
                    <li>Jeg ved ikke, hvor arbejder hun.</li>
                    <li>Der mange mennesker er i byen.</li>
                </ol>
            </section>
        `
    },
    {
        ...
        content: `
            <section class="grammar-exercise">
                <h3>A. Subjekt og finit verbum</h3>
                <ol>
                    <li>S: Min ven; V1: arbejder.</li>
                    <li>S: vi; V1: skal.</li>
                    <li>S: Hun; V1: har.</li>
                    <li>LS: S bussen, V1 kommer. HS: V1 stiger, S vi.</li>
                    <li>Foreløbigt S: Der; V1: står; egentligt S: en mand.</li>
                </ol>
            </section>
            <section class="grammar-exercise">
                <h3>B. Ligefrem eller inversion?</h3>
                <ol>
                    <li>Jeg arbejder hjemme i dag.</li>
                    <li>I dag arbejder jeg hjemme.</li>
                    <li>På stationen venter mange mennesker.</li>
                    <li>Den film har jeg ikke set.</li>
                    <li>Heldigvis fandt vi nøglerne.</li>
                </ol>
            </section>
            <section class="grammar-exercise">
                <h3>C. Centraladverbier</h3>
                <ol>
                    <li>Hun kommer ikke i morgen.</li>
                    <li>Vi har aldrig set filmen.</li>
                    <li>De vil gerne spise sammen.</li>
                    <li>Jeg arbejder ofte hjemme.</li>
                    <li>Han kan måske forstå spørgsmålet. / Måske kan han forstå spørgsmålet.</li>
                </ol>
            </section>
            <section class="grammar-exercise">
                <h3>D. Hovedsætning eller ledsætning?</h3>
                <p>Hun kommer ikke. / … at hun ikke kommer. / Vi køber ikke bilen. / … fordi vi ikke køber bilen.</p>
            </section>
            <section class="grammar-exercise">
                <h3>E. Ledsætning først</h3>
                <ol>
                    <li>Hvis det regner, bliver vi hjemme.</li>
                    <li>Når jeg kommer hjem, laver jeg mad.</li>
                    <li>Fordi hun er syg, arbejder hun ikke.</li>
                    <li>Selvom han var træt, fortsatte han videre.</li>
                </ol>
            </section>
        `
    },
    {
        ...
        content: `
            <section class="grammar-exercise">
                <h3>F. Spørgsmål</h3>
                <ol>
                    <li>Kommer du i morgen?</li>
                    <li>Hvor bor hun?</li>
                    <li>Hvad købte Peter?</li>
                    <li>Hvem kommer i morgen?</li>
                </ol>
            </section>
            <section class="grammar-exercise">
                <h3>G. Indirekte spørgsmål</h3>
                <ol>
                    <li>Jeg ved ikke, hvor han bor.</li>
                    <li>Peter spørger, om hun kommer i morgen.</li>
                    <li>Kan du forklare, hvorfor de ikke er her?</li>
                </ol>
            </section>
            <section class="grammar-exercise">
                <h3>H. Objekter</h3>
                <ol>
                    <li>Hun gav sin søster en bog.</li>
                    <li>Jeg ser ham ikke.</li>
                    <li>Vi har aldrig mødt dem.</li>
                    <li>Hun viste hende dem ikke.</li>
                </ol>
            </section>
            <section class="grammar-exercise">
                <h3>I. Det eller der?</h3>
                <ol>
                    <li>Det regner i dag.</li>
                    <li>Der står en bil udenfor.</li>
                    <li>Det er vigtigt at læse hver dag.</li>
                    <li>I haven ligger der en bold.</li>
                </ol>
            </section>
            <section class="grammar-exercise">
                <h3>J. Ret fejlene</h3>
                <ol>
                    <li>I morgen skal jeg arbejde.</li>
                    <li>Hun har ikke tid.</li>
                    <li>Jeg tror, at hun ikke kommer.</li>
                    <li>Hvis han ringer, svarer jeg.</li>
                    <li>Jeg ved ikke, hvor hun arbejder.</li>
                    <li>Der er mange mennesker i byen.</li>
                </ol>
            </section>
        `
    },
    {
        ...
        content: `
            <table class="grammar-glossary-table">
                <thead>
                    <tr>
                        <th lang="da">Dansk</th>
                        <th class="grammar-english" lang="en">English</th>
                        <th lang="da">Kort forklaring</th>
                        <th class="grammar-english" lang="en">Short explanation</th>
                    </tr>
                </thead>
                <tbody>
                    <tr>
                        <th scope="row" lang="da">ordstilling</th>
                        <td class="grammar-english" lang="en"><em>word order</em></td>
                        <td lang="da">rækkefølgen af sætningsled</td>
                        <td class="grammar-english" lang="en"><em>the sequence of sentence elements</em></td>
                    </tr>
                    <tr>
                        <th scope="row" lang="da">sætningsled</th>
                        <td class="grammar-english" lang="en"><em>sentence element</em></td>
                        <td lang="da">ord eller gruppe med en funktion</td>
                        <td class="grammar-english" lang="en"><em>a word or group with a function</em></td>
                    </tr>
                    <tr>
                        <th scope="row" lang="da">finit verbum</th>
                        <td class="grammar-english" lang="en"><em>finite verb</em></td>
                        <td lang="da">viser tid eller bydemåde</td>
                        <td class="grammar-english" lang="en"><em>shows tense or the imperative</em></td>
                    </tr>
                    <tr>
                        <th scope="row" lang="da">hovedsætning</th>
                        <td class="grammar-english" lang="en"><em>main clause</em></td>
                        <td lang="da">kan normalt stå alene</td>
                        <td class="grammar-english" lang="en"><em>can normally stand alone</em></td>
                    </tr>
                    <tr>
                        <th scope="row" lang="da">ledsætning</th>
                        <td class="grammar-english" lang="en"><em>subordinate clause</em></td>
                        <td lang="da">er underordnet en hovedsætning</td>
                        <td class="grammar-english" lang="en"><em>depends on a main clause</em></td>
                    </tr>
                    <tr>
                        <th scope="row" lang="da">V2-regel</th>
                        <td class="grammar-english" lang="en"><em>V2 rule</em></td>
                        <td lang="da">finit verbum på anden syntaktiske plads</td>
                        <td class="grammar-english" lang="en"><em>finite verb in the second syntactic position</em></td>
                    </tr>
                    <tr>
                        <th scope="row" lang="da">inversion</th>
                        <td class="grammar-english" lang="en"><em>inversion</em></td>
                        <td lang="da">finit verbum før subjekt</td>
                        <td class="grammar-english" lang="en"><em>finite verb before the subject</em></td>
                    </tr>
                    <tr>
                        <th scope="row" lang="da">centraladverbium</th>
                        <td class="grammar-english" lang="en"><em>central adverb</em></td>
                        <td lang="da">fx ikke, altid, aldrig, måske</td>
                        <td class="grammar-english" lang="en"><em>for example ikke, altid, aldrig, måske</em></td>
                    </tr>
                    <tr>
                        <th scope="row" lang="da">foreløbigt subjekt</th>
                        <td class="grammar-english" lang="en"><em>provisional subject</em></td>
                        <td lang="da">fx der før det egentlige subjekt</td>
                        <td class="grammar-english" lang="en"><em>for example der before the real subject</em></td>
                    </tr>
                    <tr>
                        <th scope="row" lang="da">ellipse</th>
                        <td class="grammar-english" lang="en"><em>ellipsis</em></td>
                        <td lang="da">underforstået udeladelse</td>
                        <td class="grammar-english" lang="en"><em>an understood omission</em></td>
                    </tr>
                </tbody>
            </table>
            <aside class="grammar-rule">
