...
const substantivGrammarPages = [
    {
        ...
        content: `
            ...
            <h3 id="sådan-finder-du-et-substantiv-how-to-identify-a-noun">
                Sådan finder du et substantiv / How to identify a noun
            </h3>
            <ul>
                <li>
                    <p>
            ...
            <table class="grammar-noun-table">
                ...
                <thead>
                    <tr>
                        <th>
                            <p><strong>Min søster købte en bog i byen.</strong></p>
                            <p><em>My sister bought a book in the city.</em></p>
                            <p>Substantiver: søster, bog, by.</p>
                            <p><em>Nouns: sister, book, city.</em></p>
                        </th>
                    </tr>
                </thead>
                <tbody></tbody>
            ...
            <table class="grammar-noun-table grammar-comparison-table grammar-comparison-table--two-column">
                ...
                <tbody>
                    ...
                    <tr class="grammar-comparison-meaning">
                        <td colspan="2" class="grammar-english" lang="en">
                            <strong>Compare:</strong> en bil → bilen (a car → the car) · et hus → huset (a house → the house)
                        </td>
                    </tr>
                </tbody>
            </table>
        ...
        content: `
            ...
            <table class="grammar-noun-table grammar-comparison-table grammar-form-table--four-column">
                ...
                <tbody>
                    ...
                    <tr class="grammar-comparison-meaning">
                        <td colspan="4" class="grammar-english" lang="en">
                            <strong>English meaning:</strong> a car · the car · cars · the cars
                        </td>
                    </tr>
                    <tr class="grammar-comparison-forms">
                        <td>et hus</td>
                    ...
                    <tr class="grammar-comparison-meaning">
                        <td colspan="4" class="grammar-english" lang="en">
                            <strong>English meaning:</strong> a house · the house · houses · the houses
                        </td>
                    </tr>
                </tbody>
            </table>
            <table class="grammar-noun-table">
                ...
                <thead>
                    <tr>
                        <th>
                            <p><strong>Den vigtigste læringsformel / The key learning formula</strong></p>
                            <p>Skriv hvert nyt ord sådan: en bog - bogen - bøger - bøgerne.</p>
                            <p><em>Write every new noun like this: en bog - bogen - bøger - bøgerne.</em></p>
                        </th>
                    </tr>
                </thead>
                <tbody></tbody>
                ...
                <tbody>
                    ...
                    <tr class="grammar-comparison-meaning">
                        <td colspan="3" class="grammar-english" lang="en">
                            <strong>English meaning:</strong> a chair · the chair · the chairs
                        </td>
                    </tr>
                </tbody>
            </table>
        ...
        content: `
            ...
            <table class="grammar-noun-table grammar-bilingual-table">
                ...
                <tbody>
                    <tr>
                        <td lang="da">
                            <strong>-er</strong><span class="grammar-word-list">en bil → bilen → biler → bilerne</span>
                        </td>
                        <td lang="en">
                            <strong>-er</strong><span class="grammar-word-list">a car → the car → cars → the cars</span>
                        </td>
                    </tr>
                    <tr>
                        <td lang="da">
                            <strong>-e</strong><span class="grammar-word-list">en stol → stolen → stole → stolene</span>
                        </td>
                        <td lang="en">
                            <strong>-e</strong><span class="grammar-word-list">a chair → the chair → chairs → the chairs</span>
                        </td>
                    </tr>
                    <tr>
                        <td lang="da">
...

    {
        ...
        content: `
            <p lang="da">
                Brug ubestemt form, når du nævner noget for første gang, eller når det ikke er vigtigt præcis hvilken person eller
                ting du mener. Brug bestemt form, når personen eller tingen allerede er kendt, tidligere nævnt eller tydeligt
                identificeret.
            </p>
            <p lang="en">
                <em>
            ...
            <table class="grammar-noun-table grammar-bilingual-table">
                ...
                <tbody>
                    ...
                    <tr>
                        <td lang="da">
                            <strong>Kendt information</strong><span class="grammar-example-line">Cyklen er blå.</span>
                        </td>
                        <td lang="en">
                            <strong>Known information</strong><span class="grammar-example-line">The bicycle is blue.</span>
                        </td>
                    </tr>
                    <tr>
                        <td lang="da">
                            <strong>En blandt flere</strong><span class="grammar-example-line">Jeg leder efter en lærer.</span>
                        </td>
                        <td lang="en">
                            <strong>One among several</strong><span class="grammar-example-line">I am looking for a teacher.</span>
                        </td>
                    </tr>
                    <tr>
                        <td lang="da">
                            <strong>En bestemt person</strong><span class="grammar-example-line">Jeg talte med læreren.</span>
                        </td>
                        <td lang="en">
                            <strong>A specific person</strong><span class="grammar-example-line">I spoke with the teacher.</span>
                        </td>
                    </tr>
                    <tr>
                        <td lang="da">
                            <strong>Generelt flertal</strong><span class="grammar-example-line">Bøger kan være dyre.</span>
                        </td>
                        <td lang="en">
                            <strong>Plural in general</strong><span class="grammar-example-line">Books can be expensive.</span>
                        </td>
                    </tr>
                    <tr>
                        <td lang="da">
...

    {
        ...
        content: `
            <h3 id="job-rolle-og-nationalitet-jobs-roles-and-nationality">
                6.1 Job, rolle og nationalitet / Jobs, roles, and nationality
            </h3>
            <p lang="da">
                Efter være eller blive står job, rolle og nationalitet ofte uden en eller et, når ordet fortæller, hvad en person er
                eller bliver. Brug artiklen, hvis der står et adjektiv, eller hvis du mener én bestemt eller mulig person blandt
                flere.
            </p>
            <p lang="en">
                <em>
...

    {
        ...
        content: `
            <h3 id="stoffer-mad-og-abstrakte-begreber-substances-food-and-abstract-concepts">
                6.2 Stoffer, mad og abstrakte begreber / Substances, food, and abstract concepts
            </h3>
            <p lang="da">
                Nogle substantiver beskriver noget, vi normalt ikke tæller som enkelte ting. Det kan være drikkevarer, madvarer,
                materialer eller abstrakte begreber, for eksempel kaffe, te, vand, vin, salt, ris, kærlighed og demokrati. Når vi
...

    {
        ...
        content: `
            <p lang="da">
                Når et adjektiv står foran et substantiv, ændrer formen sig efter en-ord, et-ord, flertal og bestemthed. Den
            ...
            <table class="grammar-noun-table grammar-bilingual-table grammar-status-table">
                ...
                <tbody>
                    <tr>
                        <td lang="da" class="grammar-result grammar-result--incorrect">
                            <strong>Forkert</strong>den store bilen · min bilen · Peters bilen
                        </td>
                        <td lang="en" class="grammar-result grammar-result--incorrect">
                            <strong>Incorrect</strong>double definiteness is used
                        </td>
                    </tr>
                    <tr>
                        <td lang="da" class="grammar-result grammar-result--correct">
                            <strong>Korrekt</strong>den store bil · min bil · Peters bil
                        </td>
                        <td lang="en" class="grammar-result grammar-result--correct">
                            <strong>Correct</strong>the definite ending is omitted
                        </td>
                    </tr>
                </tbody>
            </table>
            <table class="grammar-noun-table">
                ...
                <tbody>
                    <tr>
                        <td lang="da">
                            <strong>Bilen er stor.</strong><span class="grammar-example-line">Den store bil er min.</span>
                        </td>
                        <td lang="en">
                            <strong>The car is large.</strong><span class="grammar-example-line">The large car is mine.</span>
                        </td>
                    </tr>
                </tbody>
            </table>
        ...
        content: `
            ...
            <table class="grammar-noun-table grammar-bilingual-table">
                ...
                <tbody>
                    <tr>
                        <td lang="da">
                            <strong>glas + et bord → et glasbord</strong
        ...
        content: `
            ...
            <table class="grammar-noun-table">
                ...
                <thead>
                    <tr>
                        <th>
                            <p><strong>Vigtigt / Important</strong></p>
                            <p>Efter ejefald står substantivet uden bestemt endelse: Peters bil, ikke Peters bilen.</p>
                            <p><em>After a genitive, the noun has no definite ending: Peters bil, not Peters bilen.</em></p>
                        </th>
                    </tr>
                </thead>
                <tbody></tbody>
...

    {
        ...
        content: `
            ...
            <p lang="da">
                Nogle korte ord med en kort vokal og én slutkonsonant fordobler konsonanten, når der tilføjes en endelse.
...

    {
        ...
        content: `
            ...
            <p lang="da">
                I mange ord på -el, -en og -er forsvinder et tryksvagt e i nogle former. Nogle ord har to korrekte muligheder.
...

    {
        ...
        content: `
            <p lang="da">
                Tællelige substantiver kan normalt stå efter et tal og har en flertalsform: én stol, to stole. Utællelige
...

    {
        ...
        content: `
            <table class="grammar-noun-table grammar-bilingual-table grammar-status-table">
                ...
                <tbody>
                    <tr>
                        <td lang="da" class="grammar-result grammar-result--incorrect"><strong>Forkert</strong>Jeg har en børn.</td>
                        <td lang="en" class="grammar-result grammar-result--incorrect">
                            <strong>Incorrect</strong>I have a children.
                        </td>
                    </tr>
                    <tr>
                        <td lang="da" class="grammar-result grammar-result--correct">
                            <strong>Korrekt</strong>Jeg har et barn / to børn.
                        </td>
                        <td lang="en" class="grammar-result grammar-result--correct">
                            <strong>Correct</strong>I have one child / two children.
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td lang="da" class="grammar-result grammar-result--incorrect">
                            <strong>Forkert</strong>Min datteren hedder Liva.
                        </td>
                        <td lang="en" class="grammar-result grammar-result--incorrect">
                            <strong>Incorrect</strong>My the daughter is called Liva.
                        </td>
                    </tr>
                    <tr>
                        <td lang="da" class="grammar-result grammar-result--correct">
                            <strong>Korrekt</strong>Min datter hedder Liva.
                        </td>
                        <td lang="en" class="grammar-result grammar-result--correct">
                            <strong>Correct</strong>My daughter is called Liva.
                        </td>
                    </tr>
                    <tr class="grammar-correction-reason">
                        <td colspan="2">
                    ...
                    <tr>
                        <td lang="da" class="grammar-result grammar-result--incorrect">
                            <strong>Forkert</strong>Den lejligheden er stor.
                        </td>
                        <td lang="en" class="grammar-result grammar-result--incorrect">
                            <strong>Incorrect</strong>The the apartment is large.
                        </td>
                    </tr>
                    <tr>
                        <td lang="da" class="grammar-result grammar-result--correct">
                            <strong>Korrekt</strong>Lejligheden er stor / Den store lejlighed er stor.
                        </td>
                        <td lang="en" class="grammar-result grammar-result--correct">
                            <strong>Correct</strong>The apartment is large / The large apartment is large.
                        </td>
                    </tr>
                    <tr class="grammar-correction-reason">
                        <td colspan="2">
                    ...
                    <tr>
                        <td lang="da" class="grammar-result grammar-result--incorrect">
                            <strong>Forkert</strong>Han har to god lærer.
                        </td>
                        <td lang="en" class="grammar-result grammar-result--incorrect">
                            <strong>Incorrect</strong>He has two good teacher.
                        </td>
                    </tr>
                    <tr>
                        <td lang="da" class="grammar-result grammar-result--correct">
                            <strong>Korrekt</strong>Han har to gode lærere.
                        </td>
                        <td lang="en" class="grammar-result grammar-result--correct">
                            <strong>Correct</strong>He has two good teachers.
                        </td>
                    </tr>
                    <tr class="grammar-correction-reason">
                        <td colspan="2">
                    ...
                    <tr>
                        <td lang="da" class="grammar-result grammar-result--incorrect"><strong>Forkert</strong>Hun er en lærer.</td>
                        <td lang="en" class="grammar-result grammar-result--incorrect">
                            <strong>Incorrect</strong>She is a teacher (with an unnecessary Danish article).
                        </td>
                    </tr>
                    <tr>
                        <td lang="da" class="grammar-result grammar-result--correct"><strong>Korrekt</strong>Hun er lærer.</td>
                        <td lang="en" class="grammar-result grammar-result--correct"><strong>Correct</strong>She is a teacher.</td>
                    </tr>
                    <tr class="grammar-correction-reason">
                        <td colspan="2">
                    ...
                    <tr>
                        <td lang="da" class="grammar-result grammar-result--incorrect">
                            <strong>Forkert</strong>Jeg drikker en kaffe hver dag.
                        </td>
                        <td lang="en" class="grammar-result grammar-result--incorrect">
                            <strong>Incorrect</strong>I drink one coffee every day (when coffee is meant generally).
                        </td>
                    </tr>
                    <tr>
                        <td lang="da" class="grammar-result grammar-result--correct">
                            <strong>Korrekt</strong>Jeg drikker kaffe hver dag.
                        </td>
                        <td lang="en" class="grammar-result grammar-result--correct">
                            <strong>Correct</strong>I drink coffee every day.
                        </td>
                    </tr>
                    <tr class="grammar-correction-reason">
                        <td colspan="2">
...

    {
        ...
        content: `
            <h3 id="øvelse-a-find-substantiverne-exercise-a-find-the-nouns">
                Øvelse A: Find substantiverne / Exercise A: Find the nouns
            </h3>
            ...
            <h3 id="øvelse-b-vælg-en-eller-et-exercise-b-choose-en-or-et">
                Øvelse B: Vælg en eller et / Exercise B: Choose en or et
            </h3>
...

    {
        ...
        content: `
            <h3 id="øvelse-c-bøj-substantiverne-exercise-c-inflect-the-nouns">
                Øvelse C: Bøj substantiverne / Exercise C: Inflect the nouns
            </h3>
            <table class="grammar-noun-table grammar-bilingual-table">
                <thead>
                    <tr>
            ...
            <h3 id="øvelse-d-ubestemt-eller-bestemt-exercise-d-indefinite-or-definite">
                Øvelse D: Ubestemt eller bestemt? / Exercise D: Indefinite or definite?
            </h3>
            <table class="grammar-noun-table grammar-bilingual-table">
                <thead>
                    <tr>
                ...
                <tbody>
                    <tr>
                        <td lang="da">
                            <strong>1.</strong> Jeg købte (en bog / bogen) i går. (En bog / Bogen) handler om Danmark.
                        </td>
                        <td lang="en">I bought (a book / the book) yesterday. (A book / The book) is about Denmark.</td>
                    </tr>
                    <tr>
                        <td lang="da">
                            <strong>2.</strong> Der står (en cykel / cyklen) foran huset. Jeg tror, at (en cykel / cyklen) er Annas.
                        </td>
                        <td lang="en">
                            There is (a bicycle / the bicycle) in front of the house. I think (a bicycle / the bicycle) is Anna's.
                        </td>
                    </tr>
                    <tr>
                        <td lang="da">
                            <strong>3.</strong> På bordet ligger der tre (æbler / æblerne). (Æbler / Æblerne) er grønne.
                        </td>
                        <td lang="en">There are three (apples / the apples) on the table. (Apples / The apples) are green.</td>
                    </tr>
                    <tr>
                        <td lang="da"><strong>4.</strong> Jeg leder efter (en læge / lægen), som taler engelsk.</td>
                        <td lang="en">I am looking for (a doctor / the doctor) who speaks English.</td>
                    </tr>
                </tbody>
            </table>
        `
...

    {
        ...
        content: `
            <h3 id="øvelse-e-artikel-eller-ingen-artikel-exercise-e-article-or-no-article">
                Øvelse E: Artikel eller ingen artikel? / Exercise E: Article or no article?
            </h3>
            ...
            <h3 id="øvelse-f-stof-eller-portion-exercise-f-substance-or-serving">
                Øvelse F: Stof eller portion? / Exercise F: Substance or serving?
            </h3>
...

    {
        ...
        content: `
            <h3 id="øvelse-g-ret-fejlene-exercise-g-correct-the-mistakes">
                Øvelse G: Ret fejlene / Exercise G: Correct the mistakes
            </h3>
            ...
            <h3 id="øvelse-h-lav-sammensatte-ord-exercise-h-make-compound-nouns">
                Øvelse H: Lav sammensatte ord / Exercise H: Make compound nouns
            </h3>
...

    {
        ...
        content: `
            ...
            <ul>
                <li>
                    <p>1. lærer, besked, tavle - <em>teacher, message, board</em></p>
                </li>
                <li>
                    <p>2. bror, kaffe, køkken - <em>brother, coffee, kitchen</em></p>
                </li>
                <li>
                    <p>3. børn, bold, have - <em>children, ball, garden</em></p>
                </li>
                <li>
                    <p>4. kærlighed, tillid, venskab - <em>love, trust, friendship</em></p>
                </li>
            </ul>
            ...
            <table class="grammar-noun-table">
                ...
                <thead>
                    <tr>
                        <th>
                            <p><strong>Svar / Answers</strong></p>
                            <p>1 et hus, 2 en uge, 3 et menneske, 4 en bygning, 5 et træ, 6 en computer, 7 et barn, 8 en idé</p>
                        </th>
                    </tr>
                </thead>
                <tbody></tbody>
...

    {
        ...
        content: `
            ...
            <ul>
                <li>
                    <p>1. en bog; Bogen - <em>a book; The book</em></p>
                </li>
                <li>
                    <p>2. en cykel; cyklen - <em>a bicycle; the bicycle</em></p>
                </li>
                <li>
                    <p>3. æbler; Æblerne - <em>apples; The apples</em></p>
                </li>
                <li>
                    <p>4. en læge - <em>a doctor</em></p>
                </li>
            </ul>
        `
    },

    {
        ...
        content: `
            <h3 id="e.-artikel-eller-ingen-artikel-article-or-no-article">
                E. Artikel eller ingen artikel / Article or no article
            </h3>
            <ul>
                <li>
                    <p>1. ingen artikel: Maria er sygeplejerske. - <em>no article: Maria is a nurse.</em></p>
                </li>
                <li>
                    <p>2. en: Maria er en dygtig sygeplejerske. - <em>en: Maria is a skilled nurse.</em></p>
                </li>
                <li>
                    <p>3. ingen artikel: Vil du have kaffe? - <em>no article: Would you like coffee?</em></p>
                </li>
                <li>
                    <p>4. en: Jeg bestilte en kop kaffe. - <em>en: I ordered a cup of coffee.</em></p>
                </li>
                <li>
                    <p>5. ingen artikel: Han blev dansker. - <em>no article: He became a Dane.</em></p>
                </li>
                <li>
                    <p>6. en: Jeg vil tale med en dansker. - <em>en: I want to speak with a Dane.</em></p>
                </li>
            </ul>
            ...
            <table class="grammar-noun-table">
                ...
                <thead>
                    <tr>
                        <th>
                            <p><strong>Svar / Answers</strong></p>
                            <p>en togstation; et telefonnummer; en skoletaske; et glasbord; et familiebillede</p>
                        </th>
                    </tr>
                </thead>
                <tbody></tbody>
        ...
        content: `
            ...
            <table class="grammar-noun-table">
                ...
                <thead>
                    <tr>
                        <th>
                            <p><strong>en bog - bogen - bøger - bøgerne: Jeg læser en bog. Bogen er spændende.</strong></p>
                            <p><em>a book - the book - books - the books: I am reading a book. The book is interesting.</em></p>
                        </th>
                    </tr>
                </thead>
                <tbody></tbody>
